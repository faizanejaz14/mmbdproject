...
calibration_offset = [206.00, -1500.00, 879.00] #(x_min - x_max)/2, (y_min - y_max)/2, (z_min - z_max)/2
...
def compute_heading(x, y):
    ...
    heading_rad += declination_angle + offset_angle
...
def get_bearing():
    ...
    return int (compute_heading(x, y))
